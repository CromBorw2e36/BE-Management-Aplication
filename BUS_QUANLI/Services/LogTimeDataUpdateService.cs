...
namespace BUS_QUANLI.Services
{
    public class LogTimeDataUpdateService : ILogTimeDataUpdateService
    {
        ...
        public void Insert(HttpRequest httpRequest, LogTimeDataUpdateModel model)
        {
            ...
            try
            {
                model.companyCode = this.dataContext.Accounts.Where(x => x.account == model.account).FirstOrDefault()!.companyCode;
            }
            catch { }
            ...
            try
            {
                var result = this.dataContext.Database.SqlQueryRaw<StatusMessage<dynamic>>(
        ...
        public StatusMessage<List<LogTimeDataUpdateModel>> Search(HttpRequest httpRequest, LogTimeDataUpdateModel model)
        {
            ...
            try
            {
                var result = this.dataContext.Database.SqlQueryRaw<LogTimeDataUpdateModel>(
